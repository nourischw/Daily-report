...
### 12. OpenTelemetry profiles enters public alpha
- **分數：** 162｜**留言：** 24｜**作者：** tanelpoder
- **來源：** opentelemetry.io
- **連結：** [查看原文](https://opentelemetry.io/blog/2026/profiles-alpha/)

### 13. Show HN: Turbolite – a SQLite VFS serving sub-250ms cold JOIN queries from S3
- **分數：** 133｜**留言：** 34｜**作者：** russellthehippo
- **來源：** github.com
- **連結：** [查看原文](https://github.com/russellromney/turbolite)

### 14. Colibri – chat platform built on the AT Protocol for communities big and small
...
### 19. Whistler: Live eBPF Programming from the Common Lisp REPL
- **分數：** 73｜**留言：** 2｜**作者：** varjag
