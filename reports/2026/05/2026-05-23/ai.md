...
Google Map等商用地圖服務使用便利，但卻潛藏國安上的危機。立委林俊憲今天(5/22)召開記者會，質疑高精度商用衛星影像已成為現代戰爭與情報蒐集的重要工具，國內的重要軍事設施，例如佳山基地、樂山雷達站及臺南基地等，至今仍可透過Google Maps、Google Earth及其他公開地圖平臺清楚辨識，甚至遭中國社群媒體大量轉載、標註與分析。他呼籲政府儘速建立管理機制，要求業者遮蔽軍事敏感設施，補���國安漏洞。
...
### 16. [微軟新版Edge for Business加入代理式上網](https://www.ithome.com.tw/news/176041)
...
5��21日趨勢科技發布資安公告指出，端點防護平臺Apex One、Apex One as a Service、Vision One Endpoint 安全 - Standard Endpoint Protection（SEP）存在一系列的資安漏洞，其中一個漏洞出現遭到利用的跡象。
...
多國執��機關宣布查緝並關閉First VPN，這項VPN服務長期活躍於俄語網路犯罪論壇。歐洲刑警組織（Europol）指出，近年該組織參與支援的重大網路犯罪調查中，幾乎都曾出現First VPN的蹤跡；犯罪分子藉此掩飾身分並隱匿攻擊基礎架構，從事勒索軟體攻擊、大規模詐欺、資料竊取與其他重大犯罪活動。
...
### 24. [針對微��近日修補的Microsoft Defender零時差漏洞，有專家指出已在一個月前就有概念驗證程式碼](https://www.ithome.com.tw/news/176033)
...
思科本週釋出安全更新，修補雲���零信任安全產品Secure Workload一個風險值10.0、允許駭客以管理員權限透過API存取網站資源的重大漏洞。
...
不少企業還在思考是否全面導入生成式AI助手時，老牌數據分析大廠SAS已開始面對下一個��題：當員工都能自行建立AI代理（AI 代理）後，企業該如何治理、擴散，甚至將這些AI能力進一步產品化？
...
### 30. [Claude託���代理現可連企業內網並在自有環境執行工具](https://www.ithome.com.tw/news/176026)
